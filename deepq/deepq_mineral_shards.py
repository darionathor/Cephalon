...
from baselines.deepq.utils import ObservationInput, Uint8Input
...
def learn(env,
  ...
  def make_obs_ph(name):
    return Uint8Input((16, 16), name=name)
  ...
  while(not_spawned):
      ...
      # print (obs[0].observation["feature_screen"])
      # print("player relative: \n")
      # print (obs[0].observation["feature_screen"][_PLAYER_RELATIVE])
