...
flags.DEFINE_integer("batch_size", 180, "Size of training batch.")
...
flags.DEFINE_string("agent", "deepq.deepq.DeepQAgent", "Which agent to run.")
...
from deepq import deepq_handler


def _main(unused_argv):
  deepq_handler.deepq_handler(unused_argv)
